# ivy-rest. Maintained by [nosejs](https://github.com/nosejs/ivy-rest).
...
- [ivy-rest. Maintained by nosejs.](#ivy-rest-maintained-by-nosejs)
- [Demo](#demo)
- [Current stage](#current-stage)
- [Renaming project from ng2-restangular to ivy-rest](#renaming-project-from-ng2-restangular-to-ivy-rest)
...
- [FAQ](#faq)
      ...
      - [**I use Mongo and the ID of the elements is `_id` not `id` as the default. Therefore requests are sent to undefined routes**](#i-use-mongo-and-the-id-of-the-elements-is-id-not-id-as-the-default-therefore-requests-are-sent-to-undefined-routes)
